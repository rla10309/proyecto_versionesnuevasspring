INSERT INTO `festivalrock`.`grupos` (`miembros`, `estilo`, `origen`, `nombre`, `imagen`, `descripcion`, `descripcioncorta`) VALUES ('4', 'Pop', 'Suecia', 'ABBA', '../img/abbaOscura.png', 'Waterloooooo.  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus arcu nibh, vehicula a vulputate ut, congue in nibh. Phasellus arcu nibh, vehicula a vulputate ut, congue in nibh.Phasellus arcu nibh. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus arcu nibh, vehicula a vulputate ut, congue in nibh.', 'Directamente para ti');
INSERT INTO `festivalrock`.`grupos` (`miembros`, `estilo`, `origen`, `nombre`, `imagen`, `descripcion`, `descripcioncorta`) VALUES ('3', 'Rock', 'UK', 'The Police', '../img/thePolicegrande.jpg', 'So lonely.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus arcu nibh, vehicula a vulputate ut, congue in nibh. Phasellus arcu nibh, vehicula a vulputate ut, congue in nibh.Phasellus arcu nibh.', 'Directamente para ti'); 
INSERT INTO `festivalrock`.`grupos` (`miembros`, `estilo`, `origen`, `nombre`, `imagen`, `descripcion`, `descripcioncorta`) VALUES ('4', 'Rock', 'UK', 'Queen', '../img/queenGrande.jpg', 'Bohemian Rapsody.  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus arcu nibh, vehicula a vulputate ut.', 'Directamente para ti');
INSERT INTO `festivalrock`.`grupos` (`miembros`, `estilo`, `origen`, `nombre`, `imagen`, `descripcion`, `descripcioncorta`) VALUES ('3', 'Gruge', 'USA', 'Nirvana', '../img/nirvana2.jpg', 'Una pena todo. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus arcu nibh, vehicula a vulputate ut.', 'Directamente para ti');
